...
test("composed-class-names rule fails on missing local class names", () => {
  return stylelint
    .lint(
      configuration({
        files: require.resolve(
          "../fixtures/composed-class-names/fails-local-class-name.css"
        ),
      })
    )
    .then(function (resultObject) {
...
test("composed-class-names rule fails on missing external class names", () => {
  return stylelint
    .lint(
      configuration({
        files: require.resolve(
          "../fixtures/composed-class-names/fails-external-class-names.css"
        ),
      })
    )
    .then(function (resultObject) {
...
test("composed-class-names rule fails on missing external file", () => {
  return stylelint
    .lint(
      configuration({
        files: require.resolve(
          "../fixtures/composed-class-names/fails-external-file-not-found.css"
        ),
      })
    )
    .then(function (resultObject) {
...
test("composed-class-names rule fails on path that is not a file", () => {
  return stylelint
    .lint(
      configuration({
        files: require.resolve(
          "../fixtures/composed-class-names/fails-external-path-not-a-file.css"
        ),
      })
    )
    .then(function (resultObject) {
...
test("composed-class-names rule fails on missing class names despite partial matches", () => {
  return stylelint
    .lint(
      configuration({
        files: require.resolve(
          "../fixtures/composed-class-names/fails-partial-class-names.css"
        ),
      })
    )
    .then(function (resultObject) {
